...
Note: You'll need the `x-badidea` header in your `~/.docker/config.json` described above. Then:

```
DOCKER_TLS_VERIFY=1 DOCKER_HOST=tcp://badidea-<something>-uk.a.run.app:80 docker version
...
Server: badidea
 Engine:
  Version:
